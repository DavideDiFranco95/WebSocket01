...
import co.develhope.websocket1.entities.MessageFromClientDTO;
...
public class NotificationController {
    ...
    public MessageDTO handleMessageFromWebSocket(@RequestBody MessageFromClientDTO messageFromClientDTO){
